...
/**
 * @author Group-A Aaryan Pawar Harsh Garg Pulkit Bhargava Rudra Tiwari Shruti
 *         Sharma Vedant Patel
 *
 */
...
////				System.out.println(studentUserIdApproval.getClass());
			studentList.forEach(it -> {
				try {
					...
					notificationInterface.sendNotification(NotificationTypeConstant.REGISTRATION, it.getUserId(), null,
							0);
...
//			}
			...
			try {
				...
				// send notification from system
				notificationInterface.sendNotification(NotificationTypeConstant.REGISTRATION, studentUserIdApproval,
						null, 0);
